    ...
    <section className="conversion-section">
      <div className="container">
        <div className="conversion-block">
          <h2>Ready to Simplify Your Business Registration?</h2>
          ...
          <div className="conversion-ctas">
            <button
              ...
              onClick={() => openWA("Business Registration")}
              style={{ fontSize: 15, padding: "16px 32px" }}
            >
              <i className="fa fa-whatsapp"></i> Talk to a Registration Expert
            </button>

            <button
              className="btn btn-outline-dk"
              onClick={() => openWA("Registration Consultation")}
              style={{
                color: "#fff",
